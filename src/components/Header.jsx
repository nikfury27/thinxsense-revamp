    ...
    <>
      <header className="w-full h-header-height bg-white/80 backdrop-blur-md border-b border-outline-variant flex items-center justify-between px-margin-page sticky top-0 z-40 shrink-0 overflow-hidden shadow-sm">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          >
            ...
            <span>Shift Handover Digest</span>
            {!isHandedOver && (
        ...
        <div className="flex-1 flex justify-center relative z-10">
          <h2 className="font-headline-lg text-headline-lg italic font-black text-primary select-none tracking-tight">
            thinxsense
          </h2>
        </div>
      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 bg-black/40 flex justify-end animate-fadeIn">
          ...
          {/* Drawer Container */}
          <div className="w-[450px] bg-white h-full shadow-2xl border-l border-outline-variant flex flex-col p-6 overflow-y-auto animate-slideLeft relative">
            ...
            <div className="bg-surface-container-low p-4 rounded-xl border border-outline-variant/60 mb-6 text-sm space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-on-surface">Shift A (06:00 - 18:00)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-secondary font-medium">Duty Operator:</span>
            ...
            <div className="space-y-4 mb-6">
              <h4 className="font-bold text-xs uppercase tracking-wider text-secondary">
                Shift Activity Digest (Last 12 Hours)
              </h4>
